...
fn midnight_dark() -> Theme {
    Theme {
        background: rgb(0x0d0d0e),
        terminal: rgb(0x0d0d0e),
        titlebar: rgb(0x0d0d0e),
        sidebar: rgb(0x111112),
        panel: rgb(0x161617),
        elevated: rgb(0x1a1a1c),
        hover: rgb(0x202023),
        selection: rgb(0x262629),
        border_subtle: rgb(0x252527),
        foreground: rgb(0xe0e0e3),
        muted: rgb(0xa0a0a8),
        subtle: rgb(0x707078),
