        ...
        .run(move |cx: &mut App| {
            ...
            cx.set_menus(vec![
                Menu {
                    name: "Vibra".into(),
                    items: vec![
                        MenuItem::action("Ajustes…", ShowSettings),
                        MenuItem::action("Buscar actualizaciones…", CheckForUpdates),
                        MenuItem::separator(),
                        MenuItem::os_submenu("Servicios", SystemMenuType::Services),
                        MenuItem::separator(),
                        MenuItem::action("Salir de Vibra", Quit),
                    ],
                },
                Menu {
                    name: "Archivo".into(),
                    items: vec![
                        MenuItem::action("Nuevo workspace", NewWorkspace),
                        MenuItem::action("Nueva pestaña de terminal", NewTerminalTab),
                        MenuItem::separator(),
                        MenuItem::action("Abrir carpeta actual en…", OpenIde),
                        MenuItem::separator(),
                        MenuItem::action("Cerrar terminal", CloseTerminal),
                    ],
                },
                Menu {
                    name: "Edición".into(),
                    items: vec![
                        MenuItem::action("Copiar", CopyTerminal),
                        MenuItem::action("Pegar", PasteTerminal),
                    ],
                },
                Menu {
                    name: "Visualización".into(),
                    items: vec![
                        MenuItem::action("Mostrar/ocultar sesiones", ToggleLeftSidebar),
                        MenuItem::action("Mostrar/ocultar Archivos / Git", ToggleRightSidebar),
                        MenuItem::action(
                            "Mostrar/ocultar terminal de desarrollo",
                            ToggleDevTerminal,
                        ),
                        MenuItem::separator(),
                        MenuItem::action("Paleta de comandos", ToggleCommandPalette),
                        MenuItem::action("Apertura rápida", QuickOpen),
                    ],
                },
                Menu {
                    name: "Ventana".into(),
                    items: vec![
                        MenuItem::action("Workspace anterior", PreviousWorkspace),
                        MenuItem::action("Workspace siguiente", NextWorkspace),
                        MenuItem::separator(),
                        MenuItem::action("Ir a la pestaña 1", GoToTab { index: 1 }),
                        MenuItem::action("Ir a la pestaña 2", GoToTab { index: 2 }),
                        MenuItem::action("Ir a la pestaña 3", GoToTab { index: 3 }),
                        MenuItem::action("Ir a la pestaña 4", GoToTab { index: 4 }),
                        MenuItem::action("Ir a la pestaña 5", GoToTab { index: 5 }),
                        MenuItem::action("Ir a la pestaña 6", GoToTab { index: 6 }),
                        MenuItem::action("Ir a la pestaña 7", GoToTab { index: 7 }),
                        MenuItem::action("Ir a la pestaña 8", GoToTab { index: 8 }),
                        MenuItem::action("Ir a la última pestaña", GoToTab { index: 9 }),
                    ],
                },
            ]);
