...
The terminal engine is provided by
[libghostty](https://github.com/ghostty-org/ghostty) through the MIT-licensed
[libghostty-spm](https://github.com/egoist-labs/libghostty-spm) wrapper.

Built-in terminal color themes come from the `GhosttyTheme` module in
libghostty-spm, which redistributes schemes from
